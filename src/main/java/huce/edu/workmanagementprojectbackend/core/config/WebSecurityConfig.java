package huce.edu.workmanagementprojectbackend.core.config;

import huce.edu.workmanagementprojectbackend.services.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/", "/login","/logout").permitAll() // Các trang không yêu cầu login
                .regexMatchers("/leader_manager.*","/leader-task-list.*","/save_task.*","/delete_task.*").access("hasAnyRole('ROLE_LEADER')")
